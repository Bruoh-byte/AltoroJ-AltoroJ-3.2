...
Changed code AltoroJ-AltoroJ-3.2/WebContent/bank/ //created chartJSLibrary and chartJSLibrary_Secure folders to house each library used
  then in each of these folders, there is the corresponding library js file in it
...
In WebContent/bank/chartJSLibrary/Chart(1).js, we see the vulnerable chart js library that is being used. According to the NVD, the vulnerability
this library introduces in a 9.8 critical vulnerably. 
In WebContent/bank/chartJSLibrary_Secure/chart.umd.js, we see the most up-to-date chart js library that can also be used. This library doesn't have
known vulnerabilities and is secure. 
...
Passing Cases: 
The chart showing up in Microsoft Edge, Firefox, and Google Chrome
